...
export default function FlameShader({ falloff = 3, glowInternalRadius = 1.0, glowColor = 'orange', glowSharpness = 1.0 , isBoosting = false}) {
	...
	// @ts-ignore
	return (<fakeFlame key={FakeFlame.key} side={DoubleSide} transparent={true} blending={AdditiveBlending} depthTest={false} ref={ref}/>)
}